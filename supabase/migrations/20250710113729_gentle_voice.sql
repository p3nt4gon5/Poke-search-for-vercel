/*
  ...
  1. New Tables
    - `email_notifications_log` - Логирование отправленных уведомлений
  
  2. New Fields
    - `email_notifications` в таблице profiles для управления подпиской
  
  3. Functions
    - `notify_users_about_new_pokemon()` - Функция для отправки уведомлений
  
  4. Triggers
    - Триггер на добавление нового покемона
*/
